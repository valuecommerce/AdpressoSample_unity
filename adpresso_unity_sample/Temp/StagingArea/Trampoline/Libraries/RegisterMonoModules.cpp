...
extern "C"
{
    ...
    const char*         UnityIPhoneRuntimeVersion = "5.4.1f1";
...
#define DLL_EXPORT
    ...
    DECL_USER_FUNC(_AdView_Init);
    DECL_USER_FUNC(_AdView_SetPublisherId);
    DECL_USER_FUNC(_AdView_SetGapPublisherId);
    DECL_USER_FUNC(_AdView_ShowHide);
    DECL_USER_FUNC(_AdView_FadeIn);
    DECL_USER_FUNC(_AdView_FadeOut);
    DECL_USER_FUNC(_AdView_SetPosition);
    DECL_USER_FUNC(_AdView_Log);
    DECL_USER_FUNC(_AdpressoIntersitial_Init);
    DECL_USER_FUNC(_AdpressoIntersitial_Show);
    DECL_USER_FUNC(_AdpressoIntersitial_Cancel);
}
DLL_EXPORT void RegisterMonoModules()
{
    ...
    REGISTER_USER_FUNC(_AdView_Init);
    REGISTER_USER_FUNC(_AdView_SetPublisherId);
    REGISTER_USER_FUNC(_AdView_SetGapPublisherId);
    REGISTER_USER_FUNC(_AdView_ShowHide);
    REGISTER_USER_FUNC(_AdView_FadeIn);
    REGISTER_USER_FUNC(_AdView_FadeOut);
    REGISTER_USER_FUNC(_AdView_SetPosition);
    REGISTER_USER_FUNC(_AdView_Log);
    REGISTER_USER_FUNC(_AdpressoIntersitial_Init);
    REGISTER_USER_FUNC(_AdpressoIntersitial_Show);
    REGISTER_USER_FUNC(_AdpressoIntersitial_Cancel);
}
